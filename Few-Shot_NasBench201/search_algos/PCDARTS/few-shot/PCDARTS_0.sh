#!/bin/bash
# bash ./scripts-search/algos/PCDARTS/PCDARTS_0.sh cifar10 0 -1 0 BENCHMARK_PATH
...
save_dir=./output/few-shot-NAS/PCDARTS-${dataset}-BN${BN}/runs-${run}

OMP_NUM_THREADS=4 python ./exps/algos/PCDARTS-few-shot.py \
