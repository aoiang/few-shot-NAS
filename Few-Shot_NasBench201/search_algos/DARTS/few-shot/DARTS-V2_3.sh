#!/bin/bash
# bash ./scripts-search/algos/DARTS/DARTS-V2_3.sh cifar10 0 -1 0 BENCHMARK_PATH
...
save_dir=./output/few-shot-NAS/DARTS-V2-${dataset}-BN${BN}/runs-${run}

OMP_NUM_THREADS=4 python ./exps/algos/DARTS-V2-few-shot.py \
